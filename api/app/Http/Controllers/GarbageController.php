...
class GarbageController extends Controller
{
  ...
  public function changeArrayPrice()
  {
    try {
      \DB::beginTransaction();
      ...
      foreach ($homes as $key => $home) {
        ...
        if ($ru[2]['name'] == "price") {
          ...
          //   $ru[2]['fields'][5],
          // ];
          $ru[2]['fields'][0]['value'] = $am[2]['fields'][0]['value'];
          $ru[2]['fields'][1]['value'] = $am[2]['fields'][1]['value'];
          $ru[2]['fields'][2]['value'] = $am[2]['fields'][2]['value'];
          $ru[2]['fields'][3]['value'] = $am[2]['fields'][3]['value'];
        ...
        if ($en[2]['name'] == "price") {
          ...
          $en[2]['fields'][0]['value'] = $am[2]['fields'][0]['value'];
          $en[2]['fields'][1]['value'] = $am[2]['fields'][1]['value'];
          $en[2]['fields'][2]['value'] = $am[2]['fields'][2]['value'];
          $en[2]['fields'][3]['value'] = $am[2]['fields'][3]['value'];
